...
def load_data(filename):
  ...
  with open(filename) as json_file:
    ...
    data = sorted(data,key=lambda car: car['total_sales'])
...
#  locale.setlocale(locale.LC_ALL, 'en_US.UTF8')
  ...
  summary = [
      ...
      'The {} had the most sales{}'.format(sales["car"]["car_model"],sales["total_sales"]),'The most popular year was{} with {} sales.'.format(max_key , max_value),]
  return summary
...
def main(argv):
  ...
  data = load_data("/home/{}/Car_Sales/car_sales.json".format(user))
  summary = process_data(data)
  new_summary = '<br/>'.join(summary)
  print(summary)
  # TODO: turn this into a PDF report
  report('/tmp/cars.pdf' , "Cars reports" ,new_summary, cars_dict_to_table(data))
  msg = email_generate("jack******@gmail.com","doll****@gmail.com",
